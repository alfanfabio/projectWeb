...
<h1>Profil</h1>
<h5 style="text-align:center;"><b>Walikota Bitung</b></h5>
<a class="gambarprofil">
    <img src="/img/walikota.jpg" alt="" width="120" height="150"></a>
<h5 style="text-align:center;">Ir. Murits Mantiri, M.M.</h5><br>
<br>
<h5 style="text-align:center;"><b>Wakil Walikota Bitung</b></h5>
<a class="gambarprofil">
    <img src="/img/wakil.jpg" alt="" width="120" height="150">
</a>
<h5 style="text-align:center;">Hengky Honandar,SE</h5><br>
<br>
<h5 style="text-align:center;"><b>Kepala Dinas Kesehatan Bitung</b></h5>
<a class="gambarprofil">
    <img src="/img/kadis.jpg" alt="" width="120" height="150">
</a>
...
<div class="container-fluid" style="width:1000px; background-color:aquamarine;">
    ...
    <p style="  text-align:center;  ">Terwujudnya Bitung Kota Digital yang
        ...
        <br>Penjelasan visi tersebut didasarkan pada 5 (lima) kata kunci yang yaitu:<br>
        1. Digital:<br>
        Saat ini kita berada di era digital. Sebuah periode yang ditandai oleh dominasi teknologi informasi dan komunikasi (TIK) internet. Sebagaimana telah dipahami bahwa digital adalah kata serapan dari bahasa asing yang dapat kita lihat asal katanya yaitu digit dan imbuhan al. Dengan imbuhan al menjadikan digital sebagai kata sifat yang bermakna bersifat digit.
        <br>
        <br>Kata digital sudah resmi menjadi bahasa indonesia. Digital dapat berupa kata sifat atau kata benda. Sebagai kata sifat, digital berarti bilangan dan angka, sedangkan sebagai kata benda, digital berarti alat untuk hasil produk. Menurut kamus besar bahasa Indonesia (KBBI) Digital berhubungan dengan angka-angka untuk sistem perhitungan tertentu; berhubungan dengan penomoran. Pada perkembangannya kata digital merujuk pada pekembangan teknologi komunikasi dan informasi, yaitu bagaimana bidang tersebut menggunakan teknologi digital baik dalam proses pengemasan informasi,
        transmisi data maupun penerimaannya.<br>
        <br>Sesuai dengan harapan Walikota dan Wakil Walikota Bitung bahwa dalam menjawab ketidakpastian, ketidakadilan dan diskriminasi, maka perlu digitalisasi daerah. Dalam artian bahwa dengan digitalisasi maka ketidakpastian,ketidakadilan dan diskriminasi dapat dihilangkan. Ketidakpastian, ketidakadilan, dan publik. Untuk itu maka pelayanan publik hendaknya dilakukan secara digital. Hal inilah yang dimaksudkan dengan digitalisasi, dengan maksud bahwa tentunya
        sistem pemerintahan harus berbasis elektronik (SPBE).<br>
        <br>Untuk mencapai tujuan SPBE atau e-Gov, maka pemerintah daerah harus membangun sistem kota cerdas (smart city), atau kota digital. Untuk mewujudkan konsep kota cerdas (smart city) dan/atau kota digital(digital city), pemerintah daerah perlu menyiapkan berbagai kebutuhan, mulai dari
        infrastruktur digital, sumber daya manusia, hingga sistem digital. Bagi Kota Bitung, dalam pemerintahan yang baru ini, penerapan SPBE atau e-Gov akan semakin dipacu agar mampu meningkatkan kesejahteraan masyarakat. Namun tidak sekedar SPBE dan kota cerdas melainkan mencoba untuk melakukan lompatan dengan program kota digital yang cakupannya lebih luas dibandingkan dengan kotea cerda. Sebab, kota digital menuntut peran aktif semua pihak dan menuntut penggunaan aplikasi digital secara full dalam semua aspekkehidupan kota dan terutama pada layanan publik.
        ...
        <br>5. Gotong Royong: <br>
        Memiliki makna semangat gotong sebagai budaya masyarakat sulawesi utara yang saling tolong menolong, saling peduli terhadap yang lain. Semangat gotong royong inilah yang terus dipelihara sebagai salah satu modal dalam pembangunan.<br>
